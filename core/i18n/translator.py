...
_KO.update(
    {
        # ── F3-1/F5: field validation and reanalyze-contract display strings ──
        "{field}: enter a date.": "{field}: 날짜를 입력하세요.",
        "{field}: use YYYY-MM-DD format.": "{field}: YYYY-MM-DD 형식으로 입력하세요.",
        "{field}: enter a whole number.": "{field}: 정수를 입력하세요.",
        "{field}: enter a number.": "{field}: 숫자를 입력하세요.",
        "{field}: this field is required.": "{field}: 필수 입력 항목입니다.",
        "Reanalysis failed: {error}": "재분석 실패: {error}",

        # ── F3-1/F3-4: reanalyze contract and review filters ────────────────
        "Reanalysis is unavailable in this session.": "이 세션에서는 다시 분석을 사용할 수 없습니다.",
        "This message was manually edited. Reanalyzing will discard your edits. Continue?":
            "이 메시지는 수동으로 수정했습니다. 다시 분석하면 수정 내용이 사라집니다. 계속하시겠습니까?",
        "Already-applied messages are not reanalyzed. Use guided edit to add a correction instead.":
            "이미 반영된 메시지는 다시 분석하지 않습니다. 수정하려면 안내 편집을 사용하세요.",
        "Advanced raw edit": "고급 원본 편집",
        "Created {count} record(s).": "{count}건 생성됨",
        "Already recorded (duplicate).": "이미 기록됨 (중복)",
        "Created {created} · duplicate {duplicate}.": "{created}건 생성 · 중복 {duplicate}건",
        "Save failed: {error}": "저장 실패: {error}",
        "Applied (see created records).": "반영됨 (생성된 기록 확인)",
        "Technical details": "기술 정보",
        "Source message": "원본 메시지",
    }
)
...
_KO.update(
    {
        "Show": "표시",
        "Candidates": "후보",
        "Already applied": "이미 반영됨",
        "Errors": "오류",
        "Edit extracted result": "추출 결과 수정",
        "Edit extracted values with the same guided fields used by manual entry. Dates must use YYYY-MM-DD.": "수동 입력과 같은 안내 필드로 추출 값을 수정합니다. 날짜는 YYYY-MM-DD 형식이어야 합니다.",
        "Review and correct only the fields needed for this record.": "이 기록에 필요한 필드만 확인하고 수정하세요.",
        "Field": "필드",
        "Value": "값",
        "Original message ID": "원본 메시지 ID",
        "Record type": "기록 유형",
        "Created records": "생성된 기록",
        "Duplicate records": "중복 기록",
        "Extracted records": "추출된 기록",
        "Milestone or award record": "마일스톤/수상 기록",
        "Team move record": "팀 이동 기록",
        "Injury record": "부상 기록",
        "Extracted record": "추출 기록",
        "Add one record at a time. Choose a type below; the form shows only the fields needed for that record type. Message review corrections use the same guided fields.": "한 번에 하나의 기록을 추가합니다. 아래에서 유형을 고르면 필요한 필드만 표시됩니다. 메시지 검토 수정도 같은 안내 필드를 사용합니다.",
        "Trade": "트레이드",
        "FA contract": "FA 계약",
        "Extension contract": "연장 계약",
        "Injury": "부상",
        "Most Valuable Player award": "MVP 수상",
        "Cy Young award": "사이영상 수상",
        "Great Glove award": "Great Glove 수상",
        "Platinum Stick award": "Platinum Stick 수상",
        "Rookie of the Year award": "올해의 신인상 수상",
        "Player of the Month award": "이달의 선수상",
        "All-Star selection": "올스타 선정",
        "Division title": "지구 우승",
        "World Series title": "월드시리즈 우승",
        "Hall of Fame induction": "명예의 전당 헌액",
        "Trade deadline news": "트레이드 마감 뉴스",
        "Retirement news": "은퇴 뉴스",
        "Wild card news": "와일드카드 뉴스",
        "Playoff clinch news": "플레이오프 진출 뉴스",
        "All-Star voting news": "올스타 투표 뉴스",
        "Hall of Fame voting news": "명예의 전당 투표 뉴스",
        "Player of the Week news": "이주의 선수 뉴스",
        "Unrecognized message": "인식되지 않은 메시지",
        "Trade deadline article; no transaction record.": "트레이드 마감 기사이며 거래 기록이 아닙니다.",
        "Retirement article; no configured milestone record.": "은퇴 기사이며 설정된 마일스톤 기록이 없습니다.",
        "Wild card article; no matching milestone key.": "와일드카드 기사이며 대응되는 마일스톤 키가 없습니다.",
        "Playoff clinch article; no configured milestone key.": "플레이오프 진출 기사이며 설정된 마일스톤 키가 없습니다.",
        "All-Star voting article; wait for final roster.": "올스타 투표 기사입니다. 최종 명단을 기다리세요.",
        "Hall of Fame voting article; wait for final result.": "명예의 전당 투표 기사입니다. 최종 결과를 기다리세요.",
        "Player of the Week is intentionally not recorded.": "이주의 선수는 의도적으로 기록하지 않습니다.",
        "Message type is not recognized.": "메시지 유형을 인식하지 못했습니다.",
        "Message date is required before saving.": "저장 전 메시지 날짜가 필요합니다.",
        "Tracked team is not involved.": "추적 팀이 관련되지 않았습니다.",
        "Already reflected in records.": "이미 기록에 반영되었습니다.",
        "Source text changed; review again before saving.": "원본 텍스트가 변경되었습니다. 저장 전 다시 검토하세요.",
        "Source file could not be read.": "원본 파일을 읽을 수 없습니다.",
        "Excluded by reviewer.": "검토자가 제외했습니다.",
        "Date confirmation required before saving.": "저장 전 날짜 확인이 필요합니다.",
        "Record target": "기록 대상",
        "Player": "선수",
        "Team": "팀",
        "Season": "시즌",
        "Games at achievement": "달성 시점 경기 수",
        "Opponent team": "상대 팀",
        "Opponent player": "상대 선수",
        "Description": "설명",
        "Joining players": "합류 선수",
        "Leaving players": "이탈 선수",
        "Move type": "이동 유형",
        "Joining team": "합류 팀",
        "Counterpart team": "상대 팀",
        "Retained by same team": "동일 팀 잔류",
        "Duration": "기간",
        "Boxscore automatic": "박스스코어 자동",
        "Message automatic": "메시지 자동",
        "Season finalization": "시즌 최종 확정",
        "Legacy migrated record": "이전 데이터 마이그레이션",
        "Validation": "검증",
    }
)
